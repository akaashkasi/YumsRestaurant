  ...
  return (
    <section className="hero" style={{ backgroundImage: `url(${heroImage})` }}>
      <div className="hero-content">
        ...
        <p>We love no-hassle ordering. Just click the button below or go to our menu page, 
          browse our vastly delicious menu for whatever you want, add them to your cart, and 
          check out. Your order will be sent to the restaurant and will be made piping hot 
